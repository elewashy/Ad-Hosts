...
///////////////////////////////////////////////////////////////////////////////////////////
    ...
    const nextButtonContainer = document.getElementById("yuidea-btn");

    // التحقق من وجود العناصر المستهدفة
    ...
    const hasNextButton = nextButtonContainer && nextButtonContainer.querySelector("button#btn6");

    // إذا وجدنا أي من العناصر المستهدفة، نعرضها ونزيل الباقي
    if (hasLinkInLoadingScreen || hasLinkInGetLinkButton || hasNextButton) {
        // إزالة كل محتوى الصفحة
        document.body.innerHTML = "";
        ...
        // ضبط التنسيقات لجعل المحتوى يظهر بشكل جميل
        document.body.style.display = "flex";
        ...
        document.querySelectorAll("button").forEach((button) => {
            ...
            button.style.backgroundColor = "#007bff"; // اللون الأزرق الافتراضي
            ...
            button.onmouseover = function () {
                ...
                button.style.transform = "scale(1.05)"; // تكبير الزر قليلاً
            };
            button.onmouseout = function () {
                button.style.backgroundColor = "#007bff"; // إعادة اللون الأصلي
                button.style.transform = "scale(1)"; // إعادة الحجم الأصلي
            };
        });
    } else {
